return {
    ...
    { name = "BioBoum",             url = "http://localhost:8000/sparql" },
    ...
    { name = "LoterreVocabularies", url = "https://sparql-endpoint.loterre.fr/LoterreVocabularies/sparql" },
    ...
    { name = "Pokemon",             url = "https://api.triplydb.com/datasets/academy/pokemon/services/pokemon/sparql" },
